<div
  class="flex flex-col rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03] xl:w-1/5"
>
  <div class="pb-5">
    <button
      class="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 p-3 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600"
    >
      <svg
        class="fill-current"
        width="21"
  ...
  <div class="no-scrollbar max-h-full overflow-auto py-6">
    <!--== Inbox Menu Start ==-->
    <nav x-data="{ isActive: 'inbox' }" class="space-y-5">
      <!--== Mailbox Group Start ==-->
      <div>
        <h3
        ...
        <ul class="flex flex-col gap-1">
          <li>
            <a
              ...
              :class="isActive === 'inbox' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              ...
              <span
                :class="isActive === 'inbox' ? 'text-brand-500 dark:text-brand-400' : 'text-gray-700 dark:text-gray-300 group-hover:text-brand-500 dark:group-hover:text-brand-400'"
              >
                3
              </span>
            </a>
          ...
          <li>
            <a
              ...
              :class="isActive === 'sent' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
          ...
          <li>
            <a
              href="#"
              class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'drafts' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
          ...
          <li>
            <a
              href="#"
              class="group flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'spam' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
              ...
              <span
                :class="isActive === 'spam' ? 'text-brand-500 dark:text-brand-400' : 'text-gray-700 dark:text-gray-300 group-hover:text-brand-500 dark:group-hover:text-brand-400'"
              >
                2
              </span>
            </a>
          ...
          <li>
            <a
              href="#"
              class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'trash' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
          ...
          <li>
            <a
              href="#"
              class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'archive' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
        ...
        <ul class="flex flex-col gap-1">
          <li>
            <a
              href="#"
              class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'starred' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
          ...
          <li>
            <a
              href="#"
              class="flex items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-sm font-medium hover:bg-brand-50 hover:text-brand-500 dark:hover:bg-brand-500/[0.12] dark:hover:text-brand-400"
              :class="isActive === 'important' ? 'text-brand-500 bg-brand-50 dark:text-brand-400 dark:bg-brand-500/[0.12]' : 'text-gray-500 dark:text-gray-400'"
            >
              <span class="flex items-center gap-3">
                <svg
                  class="fill-current"
