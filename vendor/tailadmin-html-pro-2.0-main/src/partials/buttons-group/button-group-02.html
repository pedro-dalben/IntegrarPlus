<div class="custom-scrollbar max-w-full overflow-x-auto pb-3 sm:pb-0">
  <div class="min-w-[393px]">
    <div class="inline-flex items-center shadow-theme-xs">
      <button
        type="button"
        class="inline-flex items-center gap-2 bg-brand-500 px-4 py-3 text-sm font-medium text-white ring-1 ring-inset ring-brand-500 transition first:rounded-l-lg last:rounded-r-lg hover:bg-brand-500"
      >
        <svg
          class="fill-current"
          width="20"
