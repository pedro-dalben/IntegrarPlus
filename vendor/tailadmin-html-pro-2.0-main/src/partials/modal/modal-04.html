<div x-data="{isModalOpen: false}">
  ...
  <div
    x-show="isModalOpen"
    class="fixed left-0 top-0 z-99999 flex h-screen w-full flex-col items-center justify-between overflow-y-auto overflow-x-hidden bg-white p-6 dark:bg-gray-900 lg:p-10"
  >
    <!-- close btn -->
    <button
