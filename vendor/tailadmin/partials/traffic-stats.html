...
>
  ...
  <div
    x-data="{selected: 'today'}"
    class="flex items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 dark:bg-gray-900"
  >
    <button
      @click="selected = 'today'"
      :class="selected === 'today' ? 'shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800' : 'text-gray-500 dark:text-gray-400'"
  ...
  <div>
    ...
    <div class="flex items-end justify-between py-5">
      <div>
        ...
        <h4
          class="mb-1 text-2xl font-semibold text-gray-800 dark:text-white/90"
        >
          567K
        </h4>
        <span class="flex items-center gap-1.5">
          <span class="text-success-600"> +3.85% </span>
      ...
      <div class="w-full max-w-[150px]">
        <div class="chartNine chartNine-01"></div>
      </div>
    </div>

    <!-- Stats item -->
    <div
      class="flex items-end justify-between border-y border-gray-100 py-5 dark:border-gray-800"
    >
      <div>
        <p class="mb-1 text-theme-sm text-gray-500 dark:text-gray-400">
          Conversion Rate
        ...
        <span class="flex items-center gap-1.5">
          <span class="text-error-600"> -5.39% </span>
          <span class="text-theme-xs text-gray-500 dark:text-gray-400">
            then last Week
          </span>
        </span>
      ...
      <div class="w-full max-w-[150px]">
        <div class="chartTen chartTen-01"></div>
      </div>
    </div>
    ...
    <div class="flex items-end justify-between py-5">
      <div>
        ...
        <span class="flex items-center gap-1.5">
          <span class="text-success-600"> +12.74% </span>
          <span class="text-theme-xs text-gray-500 dark:text-gray-400">
            then last Week
          </span>
        </span>
      ...
      <div class="w-full max-w-[150px]">
        <div class="chartNine chartNine-02"></div>
      </div>
    </div>
  </div>
</div>
