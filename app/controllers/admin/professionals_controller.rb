...
module Admin
  class ProfessionalsController < Admin::BaseController
    before_action :set_professional,
                  only: %i[show edit update destroy resend_confirmation send_reset_password force_confirm]
    ...
    def resend_confirmation
      ...
      if @professional.confirmation_sent_at.nil? || @professional.confirmation_sent_at < 1.hour.ago
        ...
        redirect_to admin_professional_path(@professional),
                    alert: 'Aguarde pelo menos 1 hora para reenviar o e-mail de confirmação.'
      end
    end
