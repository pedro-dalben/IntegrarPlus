  ...
  class TimelineComponent < ViewComponent::Base
    ...
    def plus_circle_icon
      content_tag :svg, class: 'h-5 w-5', fill: 'currentColor', viewBox: '0 0 20 20' do
        content_tag :path, '', 'fill-rule': 'evenodd', d: 'M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z', 'clip-rule': 'evenodd'
      end
    end

    def calendar_icon
      content_tag :svg, class: 'h-5 w-5', fill: 'currentColor', viewBox: '0 0 20 20' do
        content_tag :path, '', 'fill-rule': 'evenodd', d: 'M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z', 'clip-rule': 'evenodd'
      end
    end
