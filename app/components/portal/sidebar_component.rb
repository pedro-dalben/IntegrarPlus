...
module Portal
  class SidebarComponent < ViewComponent::Base
    ...
    def svg_icon(name)
      ...
      when "hospital"
        content_tag(:svg, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", class: "w-5 h-5") do
          tag(:path, "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M19 14l-7 7m0 0l-7-7m7 7V3m9 12V9a2 2 0 00-2-2H4a2 2 0 00-2 2v6")
        end
      when "user-plus"
        content_tag(:svg, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", class: "w-5 h-5") do
          tag(:path, "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7zM20 8v6M23 11h-6")
        end
      else
