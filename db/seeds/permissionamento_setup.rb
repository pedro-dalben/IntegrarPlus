...
permissions_data = [
  ...
  { key: 'anamneses.start', description: 'Iniciar atendimento da anamnese' },
  { key: 'anamneses.mark_attended', description: 'Registrar presença na anamnese' },
  { key: 'anamneses.mark_no_show', description: 'Registrar falta na anamnese' },
  { key: 'anamneses.cancel_anamnesis', description: 'Cancelar anamnese' },
  { key: 'anamneses.reschedule_form', description: 'Acessar formulário de reagendamento da anamnese' },
  { key: 'anamneses.reschedule', description: 'Reagendar anamnese' },
...
if prof_group
  basic_permissions = [
    ...
    'anamneses.complete',
    'anamneses.start',
    'anamneses.mark_attended',
    'anamneses.mark_no_show',
    'anamneses.cancel_anamnesis',
    'anamneses.reschedule_form',
    'anamneses.reschedule',
    'anamneses.today',
