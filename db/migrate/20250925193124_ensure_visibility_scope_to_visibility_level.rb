...
class EnsureVisibilityScopeToVisibilityLevel < ActiveRecord::Migration[8.0]
  def up
    ...
    Rails.logger.debug '✅ Índice para visibility_level criado'
  end
